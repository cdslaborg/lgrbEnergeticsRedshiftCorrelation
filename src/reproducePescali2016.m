...
d = importdata("../data/P16tableB1.xlsx"); % getLogLumDisWicMPC.m
...
zoneLim = [0.8, 12]; % 2200];
    ...
    export_fig("P16zoneEiso.png", "-m2 -transparent")
...
figure; hold on; box on;
    ...
    line([LOG_THRESH_LIM/log(10), LOG_THRESH_LIM/log(10)], [0, 40],'color','black','linewidth',2,'linestyle','--')
    ...
    set(gcf,'color',figureColor)
    set(gca,'color',figureColor, 'fontSize', fontSize)
    export_fig("P16histSbol.png", "-m2 -transparent")
hold off;
...
figure; hold on; box on;
    ...
    ylabel("Fluence [ ergs s^{-1} ]", "interpreter", "tex", "fontSize", fontSize)
    set(gca,'xscale','log','yscale','log');
    set(gcf,'color',figureColor)
    set(gca,'color',figureColor, 'fontSize', fontSize)
    export_fig("P16zoneSbol.png", "-m2 -transparent")
hold off;
