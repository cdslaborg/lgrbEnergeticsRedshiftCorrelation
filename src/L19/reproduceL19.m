...
figure("color", figureColor); hold on; box on;
    ...
    annotation('textarrow',[.63,.68],[.75,.75],'String','L19 detection threshold','fontsize',11);
...
figure("color", figureColor); hold on; box on;
    ...
    annotation('textarrow',[.625,.675],[.4,.4],'String','L19 detection threshold','fontsize',11);
...
figure("color", figureColor); hold on; box on;
    ...
    ylabel("E_{iso} Fluence [ ergs / cm^2 ]", "interpreter", "tex", "fontsize", fontSize);
...
figure("color", figureColor); hold on; box on;
    ...
    xlim(L19.thresh.logZoneLimits);
    xlabel("z + 1", "interpreter", "tex", "fontsize", fontSize);
    ylabel("E_{0} [ ergs / cm^2 ]", "interpreter", "tex", "fontsize", fontSize);
